...
const Footer = () => {
    const work = [
        {name: "Emergency Barber Service" , link: "/emergency"},
        {name: "Barber Repair" , link: "/Barber-repair"},
        {name: "String Extraction" , link: "/string-extract"},
        {name: "Barber tune" , link: "/Barber-tune"},
    ]
    const ourAddress = [
    ...
    const type = [
        {name: "HairCut" , link: "/haircut"},
        {name: "Shave" , link: "/shave"},
        ...
        <footer className="footer-area clear-both">
            <div className="container pt-5">
                ...
                <div className="copyRight text-center">
                    <p>Copyright {(new Date()).getFullYear()} All Rights Reserved By Abid Nuri</p>
                </div>
            </div>
        </footer>
